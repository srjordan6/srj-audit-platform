...
TIER_1_QUESTIONS = [
    ...
    },
    {
        ...
        "section": 'A',
        "sequence_number": 6,
        # 2026-07-15: converted from MS to LAW_INVENTORY. Options field
        # left empty; the partial renders from questionnaire.law_catalog
        # (59 laws grouped by category) at render time via
        # services._decorate_question.
        "question_text": 'Which AI-relevant laws, regulations, or frameworks does your company operate under? Check every one that applies (or would apply if a regulator asked).',
        "question_type": 'LAW_INVENTORY',
        "options": [],
        "matrix_rows": None,
        "matrix_columns": None,
        "skip_logic": None,
        ...
        "notes": 'v1.2 expansion; 2026-06-28 OD-14 expansion; 2026-07-15 converted to LAW_INVENTORY question type with 59-law catalog from ai-governance-coverage.csv (Stephen). Options rendered dynamically from questionnaire.law_catalog.',
        "is_active": True,
        "scoring_overrides": None,
        "extended_metadata": {
            'renders_categorized': True,
            'allows_other_free_text': True,
            'catalog_source': 'ai-governance-coverage.csv',
        },
    },
    {
        "id": 'T1-A-007',
