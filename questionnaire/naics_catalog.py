"""NAICS 2022 6-digit industry catalog for the signup-form dropdown.

Source: US Census Bureau -- https://www.census.gov/naics/
2022_NAICS_Structure.xlsx (accessed 2026-07-15).
1,012 6-digit US industries, grouped by 2-digit sector.

SECTORS: [(sector_code, sector_title, [(code, title), ...]), ...]
The signup form renders SECTORS as <optgroup> blocks so all 1,012
options fit in one native <select> with type-to-search.
"""
